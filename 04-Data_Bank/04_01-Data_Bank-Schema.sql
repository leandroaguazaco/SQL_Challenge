...
CREATE TABLE customer_nodes(
	...
	start_date DATE,
	end_date DATE,
	CONSTRAINT customer_nodes_fk FOREIGN KEY(region_id) REFERENCES regions(region_id) ON DELETE CASCADE
);
...
CREATE TABLE customer_transactions(
	...
	txn_type VARCHAR(10),
	txn_amount INTEGER 
	-- CONSTRAINT customer_transactions_fk FOREIGN KEY(customer_id) REFERENCES customer_nodes(customer_id) ON DELETE CASCADE
);
